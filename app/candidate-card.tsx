    ...
    <Card className="shadow-md p-6">
      ...
      <Flex direction="column" gap="4">
        ...
        <Flex wrap="wrap" gap="2">
          ...
          {candidate.whopMutuals?.score && candidate.whopMutuals.score > 0 && (
            <Badge variant="surface" color="orange">
              <Users2 className="size-4 mr-1" />
              {typeof candidate.whopMutuals.score === "number"
                ? candidate.whopMutuals.score.toFixed(2)
                : candidate.whopMutuals.score}
              Whop Mutual
            </Badge>
          )}
          {activeGithub && (
